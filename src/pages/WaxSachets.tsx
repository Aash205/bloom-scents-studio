...
import productsData from "@/data/waxSachets.json";

// ✅ Same glob as your other pages
...
const WaxSachets = () => {
  ...
  // ✅ Map image URLs & normalize categories
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg font-body text-muted-foreground max-w-2xl mx-auto">
            Transform wardrobes, drawers, and small spaces with our aromatic wax sachets.
            Long-lasting fragrance without the flame.
          </p>
        </div>
        ...
        {/* Products (square media area to match Festive/Jar) */}
            ...
            <Card key={product.id} className="group hover:shadow-luxury transition-all duration-300">
              ...
              <div className="relative aspect-square overflow-hidden rounded-t-lg bg-muted">
                ...
                <div className="absolute top-3 right-3 flex gap-2">
                  <Button size="icon" variant="secondary" className="h-8 w-8 opacity-0 group-hover:opacity-100 transition-opacity" aria-label="Add to wishlist">
              ...
              <CardContent className="p-4">
                ...
                <p className="text-sm text-primary mb-1">{product.pack}</p>
                <p className="text-sm text-muted-foreground mb-1">{product.fragrance}</p>
